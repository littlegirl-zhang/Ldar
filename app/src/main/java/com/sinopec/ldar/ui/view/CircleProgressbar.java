...
//    private int outLineColor = getResources().getColor(R.color.c_F38800);

    //外部轮廓的宽度
    private int outLineWidth = 10;

    //内部圆的颜色
    private ColorStateList inCircleColors = ColorStateList.valueOf(getResources().getColor(R.color.c_003CE0));

    //中心圆的颜色
    private int circleColor;

    //进度条的颜色
    private int progressLineColor = Color.TRANSPARENT;
//    private int progressLineColor = getResources().getColor(R.color.c_F38800);
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        if (typedArray.hasValue(R.styleable.CircleProgressbar_in_circle_color)) {
            ...
            inCircleColors = ColorStateList.valueOf(getResources().getColor(R.color.c_003CE0));
        }
        circleColor = inCircleColors.getColorForState(getDrawableState(), getResources().getColor(R.color.c_003CE0));
        typedArray.recycle();
    }
    ...
    private void validateCircleColor() {
        int circleColorTemp = inCircleColors.getColorForState(getDrawableState(), getResources().getColor(R.color.c_003CE0));
